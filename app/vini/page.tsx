...
export default function ViniPage() {
  return (
    <div className="min-h-screen bg-brand-sand pt-32 pb-24 md:pt-48 md:pb-40 px-6">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-20 md:mb-32">
          <p className="font-sans text-sm tracking-[0.3em] uppercase mb-4 text-brand-wine">
            La Nostra Cantina
          </p>
          <h1 className="font-serif text-5xl md:text-7xl lg:text-8xl text-brand-charcoal tracking-wide mb-8">
            I Nostri Vini
          </h1>
